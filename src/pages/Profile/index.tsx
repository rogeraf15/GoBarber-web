    ...
    try {
      ...
      const schema = Yup.object().shape({
        ...
        password_confirmation: Yup.string().when('old_password', {
          is: (val) => !!val.length,
          then: Yup.string().required('Campo obrigatório'),
        }).oneOf([Yup.ref('password')], 'Confiramação incorreta'),
      });
    ...
    <Container>
      ...
      <Content>
        ...
        >
          ...
          <Input name="old_password" containerStyle={{ marginTop: 24 }} icon={FiLock} type="password" placeholder="Senha atual" />
